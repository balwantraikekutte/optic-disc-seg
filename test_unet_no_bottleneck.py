...
model.load_weights('unet_residual_no_bottleneck_final2.h5')

predMask = model.predict(data, batch_size=16, verbose=1)

np.save('predMask2.npy', predMask)