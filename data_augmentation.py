...
class myAugmentation(object):
    ...
    """
    def __init__(self, train_path="Trainingc", label_path="ODSegmentationTrainingSet", merge_path="merge", aug_merge_path="aug_merge", aug_train_path="aug_train", aug_label_path="aug_label", img_type="jpg", label_type="tif"):
        """
	    Using glob to get all .img_type form path
	   """
        self.train_imgs = glob.glob(train_path+"/*."+img_type)
        self.label_imgs = glob.glob(label_path+"/*."+label_type)
    ...
    def Augmentation(self):
        ...
        for i in range(len(trains)):
            ...
            img_l = load_img(path_label+"/"+str(i)+"."+labeltype)
